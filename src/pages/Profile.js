          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
            <Stack spacing={4} sx={{ width: '70%' }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                <Box>
                  <Avatar sx={{ width: 150, height: 150 }} alt="Remy Sharp" src={user?.profilePic} />
                  <input
                    style={{ display: 'none' }}
                ...
                >
                  ...
                  <Stack direction={'row'} spacing={2}>
                    <FormControl sx={{ width: '15%' }}>
                      ...
                      <Select name="countryCode" autoWidth label="Country Code">
                        <MenuItem value="">
                          <em>None</em>
                        </MenuItem>
                    ...
                    <TextField fullWidth name="phoneNo" label="Phone Number" />
                  </Stack>
                </Stack>
              </TabPanel>
